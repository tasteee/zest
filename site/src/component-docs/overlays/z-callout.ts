...
export const zCalloutDoc: ComponentDocT = {
	...
	examples: [
		...
		defineMarkupExample({
			...
			layout: ExampleLayout.stack,
			markup: `
				<z-callout kind="note">Attribute names are kebab-case; the matching properties are camelCase.</z-callout>
				<z-callout kind="tip">Most of these components accept a tone. Neutral is almost always the right one.</z-callout>
			`
		}),
		...
		defineMarkupExample({
			...
			layout: ExampleLayout.stack,
			markup: `
				<z-callout kind="important" heading="Before you upgrade">
		...
		defineMarkupExample({
			...
			layout: ExampleLayout.stack,
			markup: `
				<z-callout kind="note" heading="Why the native dialog element" is-expandable>
				...
				<z-callout kind="tip" is-expandable>
		...
		defineMarkupExample({
			...
			layout: ExampleLayout.stack,
			markup: `
				<z-callout kind="note" heading="Design system" style="--callout-color: var(--pink)">
		...
		defineInteractiveExample({
			...
			layout: ExampleLayout.stack,
			markup: `
				<z-button id="expandAll" size="small" kind="outline">Expand all</z-button>
				<z-callout class="expandableCallout" kind="note" heading="First aside" is-expandable>
				...
				<z-callout class="expandableCallout" kind="tip" heading="Second aside" is-expandable>
	...
	attributes: [
		{ name: 'kind', type: 'note | tip | important | warning | caution', defaultValue: 'note', description: 'Which admonition this is. Picks the hue and the icon.' },
