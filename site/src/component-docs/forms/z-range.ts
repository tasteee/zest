...
export const zRangeDoc: ComponentDocT = {
	...
	playground: {
		...
		controlNames: ['label', 'min', 'max', 'step', 'show-value', 'value-prefix', 'value-suffix', 'disabled'],
	...
	examples: [
		...
		defineMarkupExample({
			...
			layout: ExampleLayout.fill,
			markup: `
				<z-range label="Disabled" min="0" max="100" show-value value-suffix="%" disabled style="width: 100%">
	...
	attributes: [
		...
		{ name: 'disabled', type: 'boolean', defaultValue: '—', description: 'Blocks both handles.' },
