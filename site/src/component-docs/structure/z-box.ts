...
export const zBoxDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'wired-row', route: '/elements/structure/wired-row', description: 'This element with the direction locked to a row.' },
		{ tag: 'wired-column', route: '/elements/structure/wired-column', description: 'This element with the direction locked to a column.' },
		{ tag: 'wired-grid', route: '/elements/structure/wired-grid', description: 'A dedicated grid with responsive auto-fit.' },
		{ tag: 'wired-row', route: '/elements/structure/wired-row', description: 'The dedicated horizontal layout primitive.' }
	]
}
