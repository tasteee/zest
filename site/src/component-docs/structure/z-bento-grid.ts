...
export const zBentoGridDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-bento-item', route: '/elements/structure/z-bento-item', description: 'The cells this grid arranges.' },
		{ tag: 'wired-grid', route: '/elements/structure/wired-grid', description: 'For uniform cells.' },
