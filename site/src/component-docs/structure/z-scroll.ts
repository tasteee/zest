...
export const zScrollDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-scroll-area', route: '/elements/structure/z-scroll-area', description: 'A lighter pure-CSS variant.' },
		{ tag: 'z-dialog', route: '/elements/overlays/z-dialog', description: 'Where overscroll containment matters most.' }
	]
}
