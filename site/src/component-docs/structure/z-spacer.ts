...
export const zSpacerDoc: ComponentDocT = {
	...
	accessibilityNotes: [
		...
		'It does not separate content semantically. Use z-separator when the gap marks a real boundary.',
	...
	related: [
		{ tag: 'wired-row', route: '/elements/structure/wired-row', description: 'The container this usually sits in.' },
		{ tag: 'wired-column', route: '/elements/structure/wired-column', description: 'The vertical counterpart.' },
		{ tag: 'z-separator', route: '/elements/structure/z-separator', description: 'When the gap should be a visible boundary.' },
		{ tag: 'z-toolbar', route: '/elements/actionables/z-toolbar', description: 'Which has its own trailing overflow slot.' }
	]
}
