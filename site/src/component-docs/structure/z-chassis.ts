...
export const zChassisDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-sidebar', route: '/elements/navigation/z-sidebar', description: 'A data-driven nav for the rail.' },
		{ tag: 'z-resizable-panels', route: '/elements/interactive/z-resizable-panels', description: 'When the split should be draggable.' },
		{ tag: 'z-scroll', route: '/elements/structure/z-scroll', description: 'Scrolling the screen content.' },
	]
}
