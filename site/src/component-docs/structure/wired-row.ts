...
export const wiredRowDoc: ComponentDocT = {
	...
	related: [
		...
		{ tag: 'wired-grid', route: '/elements/structure/wired-grid', description: 'Two-dimensional layouts.' },
		{ tag: 'z-box', route: '/elements/structure/z-box', description: 'Zest’s general-purpose flex primitive.' }
	]
}
