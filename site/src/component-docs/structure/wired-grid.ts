...
export const wiredGridDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'wired-row', route: '/elements/structure/wired-row', description: 'One-dimensional horizontal layout.' },
		{ tag: 'wired-column', route: '/elements/structure/wired-column', description: 'One-dimensional vertical layout.' },
		{ tag: 'z-bento-grid', route: '/elements/structure/z-bento-grid', description: 'Asymmetric editorial grids.' }
	]
}
