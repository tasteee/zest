...
export const zSurfaceDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-card', route: '/elements/structure/z-card', description: 'The simpler bordered container.' },
		{ tag: 'z-callout', route: '/elements/data-display/z-callout', description: 'A semantic accented block.' }
	]
}
