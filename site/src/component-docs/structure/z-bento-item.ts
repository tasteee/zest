...
export const zBentoItemDoc: ComponentDocT = {
	...
	examples: [
		...
		defineMarkupExample({
			...
			markup: `
				<z-bento-grid columns="2" row-height="10rem" gap="md">
				  <z-bento-item href="#/elements/structure/z-box">
				    <z-heading size="xs" tag="h3">Layout primitives</z-heading>
				    <z-text size="sm" color="muted">One box, every display mode.</z-text>
				  </z-bento-item>
				  <z-bento-item href="#/elements/actionables/z-button" cta-label="See the docs">
	...
	related: [
		{ tag: 'z-bento-grid', route: '/elements/structure/z-bento-grid', description: 'The grid these cells fill.' },
		{ tag: 'z-card', route: '/elements/structure/z-card', description: 'The simpler content block.' },
