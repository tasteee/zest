...
export const zDisplayDoc: ComponentDocT = {
	...
	examples: [
		...
		defineMarkupExample({
			...
			layout: ExampleLayout.fill,
			markup: `
				<wired-column gap="lg" style="max-width: 46rem">
	...
	related: [
		...
		{ tag: 'wired-column', route: '/elements/structure/wired-column', description: 'Stacks display copy with supporting content.' }
	]
}
