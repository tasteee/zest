...
// The scale anyone actually picks from. `weight` accepts the full 1–1000
// range, so this is the playground's option list, not a narrowing of the API.
export const WEIGHT_CONTROL_OPTIONS = ['100', '200', '300', '400', '500', '600', '700', '800', '900']
...
export const buildTextFamilyAttributes = (options: TextFamilyOptionsT): ApiRowT[] => {
	return [
		...
		},
		{
			...
			controlOptions: WEIGHT_CONTROL_OPTIONS
		},
		{
			name: 'tag',
			type: 'string',
...
export const TEXT_FAMILY_RELATED = {
	text: { tag: 'z-text', route: '/elements/typography/z-text', description: 'Body copy and paragraphs.' },
	heading: { tag: 'z-heading', route: '/elements/typography/z-heading', description: 'Bold headings, h1 through h6.' },
	subheading: { tag: 'z-subheading', route: '/elements/typography/z-subheading', description: 'Uppercase tracked overlines.' },
	label: { tag: 'z-label', route: '/elements/typography/z-label', description: 'Short UI labels.' },
	inline: { tag: 'z-inline', route: '/elements/typography/z-inline', description: 'Style a fragment without resetting its size.' },
	display: { tag: 'z-display', route: '/elements/typography/z-display', description: 'Viewport-clamped hero type.' },
	eyebrow: { tag: 'z-eyebrow', route: '/elements/typography/z-eyebrow', description: 'The mono kicker above a title.' }
}
