...
export const zLabelDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-field', route: '/elements/actionables/z-field', description: 'The real, associated form label.' },
		TEXT_FAMILY_RELATED.text,
		TEXT_FAMILY_RELATED.subheading,
		{ tag: 'z-stat', route: '/elements/data-display/z-stat', description: 'A labelled figure with its own layout.' }
	]
}
