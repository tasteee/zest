	...
	examples: [
		defineMarkupExample({
			...
			markup: `
				...
				<z-text size="xxl" color="muted">xxl</z-text>
				<z-text size="xl">Extra large</z-text>
				<z-text size="xl" color="muted">xl</z-text>
				<z-text size="lg">Large</z-text>
				<z-text size="lg" color="muted">lg</z-text>
				<z-text size="md">Medium — the default</z-text>
				<z-text size="md" color="muted">md</z-text>
				<z-text size="sm">Small</z-text>
				<z-text size="sm" color="muted">sm</z-text>
				<z-text size="xs">Extra small</z-text>
				<z-text size="xs" color="muted">xs</z-text>
			`
		}),
