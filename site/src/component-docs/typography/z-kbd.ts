...
export const zKbdDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-command', route: '/elements/overlays/z-command', description: 'The palette these shortcuts usually open.' },
		{ tag: 'z-menu', route: '/elements/navigation/z-menu', description: 'Menus that display shortcut hints.' },
		{ tag: 'z-tooltip', route: '/elements/overlays/z-tooltip', description: 'Another place a shortcut hint belongs.' }
	]
}
