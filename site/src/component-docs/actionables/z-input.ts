...
export const zInputDoc: ComponentDocT = {
	...
	playground: {
		...
		controlNames: ['placeholder', 'size', 'accent', 'is-invalid', 'is-disabled', 'is-readonly', 'inline'],
		slotLabel: 'Email'
	},
	...
	related: [
		{ tag: 'z-field', route: '/elements/actionables/z-field', description: 'Label, help text, and error treatment around any control.' },
		{ tag: 'z-textarea', route: '/elements/actionables/z-textarea', description: 'The multi-line sibling.' },
		{ tag: 'z-number-input', route: '/elements/actionables/z-number-input', description: 'When the value is a number with bounds.' },
		{ tag: 'z-combobox', route: '/elements/actionables/z-combobox', description: 'A field that filters a known list as you type.' }
	]
}
