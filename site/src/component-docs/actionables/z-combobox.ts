...
export const zComboboxDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-select', route: '/elements/actionables/z-select', description: 'The same panel without typing, for shorter lists.' },
		{ tag: 'z-command', route: '/elements/overlays/z-command', description: 'Filtering over actions rather than over a value.' },
		{ tag: 'z-input', route: '/elements/actionables/z-input', description: 'Free text, when the answer is not from a known list.' }
	]
}
