...
export const zFilterDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-toggle-button-group', route: '/elements/actionables/z-toggle-button-group', description: 'Single selection that keeps every option visible.' },
		{ tag: 'z-select', route: '/elements/actionables/z-select', description: 'When the facet list is too long to show as pills.' },
		{ tag: 'z-breadcrumbs', route: '/elements/navigation/z-breadcrumbs', description: 'The same crumb idea, for navigation rather than filtering.' }
	]
}
