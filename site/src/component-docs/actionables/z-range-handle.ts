...
export const zRangeHandleDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-range', route: '/elements/actionables/z-range', description: 'The parent that reads these and paints the track.' },
		{ tag: 'z-slider', route: '/elements/actionables/z-slider', description: 'A single value, with no handles to declare.' }
	]
}
