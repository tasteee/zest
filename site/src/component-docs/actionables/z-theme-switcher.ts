...
export const zThemeSwitcherDoc: ComponentDocT = {
	...
	playground: {
		...
		controlNames: ['kind', 'accent', 'is-icon-only', 'size'],
	...
	related: [
		{ tag: 'z-toggle-button-group', route: '/elements/actionables/z-toggle-button-group', description: 'The general segmented control this borrows its shape from.' },
		{ tag: 'z-switch', route: '/elements/actionables/z-switch', description: 'A binary toggle for a form field rather than a setting.' },
		{ tag: 'z-toggle-button', route: '/elements/actionables/z-toggle-button', description: 'A standalone two-state button.' }
	]
}
