...
export const zCheckboxDoc: ComponentDocT = {
	...
	playground: {
		...
		controlNames: ['size', 'accent', 'is-checked', 'is-disabled'],
	...
	related: [
		{ tag: 'z-switch', route: '/elements/actionables/z-switch', description: 'When the change takes effect immediately.' },
		{ tag: 'z-radio-group', route: '/elements/actionables/z-radio-group', description: 'When exactly one option must win.' },
		{ tag: 'z-field', route: '/elements/actionables/z-field', description: 'Label and error treatment around a group of checkboxes.' }
	]
}
