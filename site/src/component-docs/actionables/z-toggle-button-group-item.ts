...
const buildPlaygroundItem = (): HTMLElement => {
	...
	const item = document.createElement('z-toggle-button-group-item')
...
export const zToggleButtonGroupItemDoc: ComponentDocT = {
	...
	playground: {
		...
		controlNames: ['value', 'is-pressed', 'is-disabled', 'is-icon', 'accent', 'size', 'kind'],
		slotLabel: 'Bold'
	},
	...
	examples: [
		defineMarkupExample({
			...
			markup: `
				<z-toggle-button-group accent="dom" kind="outline">
				  <z-toggle-button-group-item value="bold" is-pressed>Bold</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="italic">Italic</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="underline">Underline</z-toggle-button-group-item>
		...
		defineMarkupExample({
			...
			markup: `
				<z-toggle-button-group accent="dom" kind="outline">
				  <z-toggle-button-group-item value="bold" is-icon aria-label="Bold" is-pressed>${Icons.bold}</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="italic" is-icon aria-label="Italic">${Icons.italic}</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="underline" is-icon aria-label="Underline">${Icons.underline}</z-toggle-button-group-item>
				</z-toggle-button-group>
			`
		}),
		...
		defineMarkupExample({
			...
			markup: `
				<z-toggle-button-group accent="dom" kind="outline">
				  <z-toggle-button-group-item value="draft" is-pressed>Draft</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="review">In review</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="published" is-disabled>Published</z-toggle-button-group-item>
				</z-toggle-button-group>
			`
		}),
		...
		defineMarkupExample({
			...
			markup: `
				<z-toggle-button-group accent="neutral" kind="outline">
				  <z-toggle-button-group-item value="keep" is-pressed>Keep</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="archive">Archive</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="delete" accent="sub">Delete</z-toggle-button-group-item>
				</z-toggle-button-group>
			`
		}),
		...
		defineInteractiveExample({
			...
			layout: ExampleLayout.stack,
			markup: `
				<z-toggle-button-group id="densityGroup" is-multiple accent="dom" kind="outline">
				  <z-toggle-button-group-item value="compact">Compact</z-toggle-button-group-item>
				  <z-toggle-button-group-item value="comfortable" is-pressed>Comfortable</z-toggle-button-group-item>
				</z-toggle-button-group>
	...
	related: [
		{ tag: 'z-toggle-button-group', route: '/elements/actionables/z-toggle-button-group', description: 'The parent that coordinates these items.' },
		{ tag: 'z-toggle-button', route: '/elements/actionables/z-toggle-button', description: 'A standalone toggle with no group.' }
	]
}
