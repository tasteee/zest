...
export const zSliderDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-range', route: '/elements/actionables/z-range', description: 'Two handles on one track, for a span rather than a point.' },
		{ tag: 'z-number-input', route: '/elements/actionables/z-number-input', description: 'When the exact number matters.' },
		{ tag: 'z-progress', route: '/elements/data-display/z-progress', description: 'For reporting a value rather than collecting one.' }
	]
}
