...
export const zNumberInputDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-input', route: '/elements/actionables/z-input', description: 'For digits that are not quantities — years, codes, phone numbers.' },
		{ tag: 'z-slider', route: '/elements/actionables/z-slider', description: 'When the range matters more than the exact number.' },
