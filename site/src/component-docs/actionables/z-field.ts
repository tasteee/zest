...
export const zFieldDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-input', route: '/elements/actionables/z-input', description: 'The control most often slotted here.' },
		{ tag: 'z-label', route: '/elements/typography/z-label', description: 'A bare label, for layouts that build their own field chrome.' },
		{ tag: 'z-alert', route: '/elements/overlays/z-alert', description: 'For a form-level error rather than a field-level one.' }
	]
}
