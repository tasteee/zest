...
export const zButtonDoc: ComponentDocT = {
	...
	examples: [
		...
		defineMarkupExample({
			...
			markup: `
				...
				<wired-row gap="sm">
				  <z-button accent="sub" kind="solid">Secondary</z-button>
				  <z-button accent="sub" kind="outline">Secondary</z-button>
				  <z-button accent="sub" kind="soft">Secondary</z-button>
				  <z-button accent="sub" kind="ghost">Secondary</z-button>
				</wired-row>
				<wired-row gap="sm">
				  <z-button accent="warning" kind="solid">Warning</z-button>
				  <z-button accent="warning" kind="outline">Warning</z-button>
				  <z-button accent="warning" kind="soft">Warning</z-button>
				  <z-button accent="warning" kind="ghost">Warning</z-button>
				</wired-row>
			`
		}),
		...
		defineInteractiveExample({
			...
			react: `
				function SaveButton() {
				  ...
				  return (
				    <z-button accent="dom" is-loading={isLoading || undefined} onClick={handleClick}>
				      Save changes
				    </z-button>
				  )
				}
	...
	related: [
		{ tag: 'z-button-group', route: '/elements/actionables/z-button-group', description: 'Join buttons into a segmented control.' },
		{ tag: 'z-toggle-button', route: '/elements/actionables/z-toggle-button', description: 'A button that stays pressed.' },
		{ tag: 'z-link', route: '/elements/navigation/z-link', description: 'For navigation rather than action.' },
		{ tag: 'z-toolbar', route: '/elements/actionables/z-toolbar', description: 'An action strip with roving focus.' }
	]
}
