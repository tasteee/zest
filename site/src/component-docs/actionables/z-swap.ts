...
export const zSwapDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-toggle-button', route: '/elements/actionables/z-toggle-button', description: 'A pressed-state button rather than two faces.' },
		{ tag: 'z-switch', route: '/elements/actionables/z-switch', description: 'The settings-row on/off control.' },
		{ tag: 'z-button', route: '/elements/actionables/z-button', description: 'A standard action control.' }
	]
}
