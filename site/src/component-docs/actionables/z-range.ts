...
export const zRangeDoc: ComponentDocT = {
	...
	examples: [
		...
		defineMarkupExample({
			...
			markup: `
				<z-range label="Matched accents" min="0" max="100" show-value style="width: 100%">
				  <z-range-handle value="30" accent="dom"></z-range-handle>
				  <z-range-handle value="70" accent="dom"></z-range-handle>
				</z-range>
				<z-range label="Mixed accents" min="0" max="100" show-value style="width: 100%">
				  <z-range-handle value="30" accent="dom"></z-range-handle>
	...
	related: [
		{ tag: 'z-range-handle', route: '/elements/actionables/z-range-handle', description: 'The two children this component reads.' },
		{ tag: 'z-slider', route: '/elements/actionables/z-slider', description: 'A single value on the same visual language.' },
		{ tag: 'z-filter', route: '/elements/actionables/z-filter', description: 'Faceting by category rather than by span.' }
	]
}
