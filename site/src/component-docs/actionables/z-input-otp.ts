...
export const zInputOtpDoc: ComponentDocT = {
	...
	examples: [
		...
		defineInteractiveExample({
			...
			description:
				'Mark it is-invalid, say what went wrong, and leave the digits alone. Clearing the field on failure is the single most common way to make this flow miserable.',
			layout: ExampleLayout.stack,
			markup: `
	...
	related: [
		{ tag: 'z-input', route: '/elements/actionables/z-input', description: 'For codes long enough that transcription beats cell-by-cell entry.' },
		{ tag: 'z-field', route: '/elements/actionables/z-field', description: 'Label and error treatment around the row.' },
		{ tag: 'z-kbd', route: '/elements/typography/z-kbd', description: 'For rendering keys rather than collecting them.' }
	]
}
