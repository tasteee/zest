...
export const zColorPickerDoc: ComponentDocT = {
	...
	usageGuidance: [
		...
		'If the choice is genuinely between four or five brand colours, a `z-toggle-button-group` of swatches is more direct than a picker that opens.',
	...
	related: [
		{ tag: 'z-popover', route: '/elements/overlays/z-popover', description: 'The general-purpose version of the panel this opens.' },
		{ tag: 'z-toggle-button-group', route: '/elements/actionables/z-toggle-button-group', description: 'When the palette is small enough to show without opening anything.' },
