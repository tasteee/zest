...
export const zToolbarGroupDoc: ComponentDocT = {
			...
			markup: `
				<z-toolbar>
				  ...
				  <z-toolbar-group label="Alignment">
				    <z-toggle-button is-icon kind="ghost" aria-label="Align left" is-pressed>${Icons.alignLeft}</z-toggle-button>
				    <z-toggle-button is-icon kind="ghost" aria-label="Align center">${Icons.alignCenter}</z-toggle-button>
				    <z-toggle-button is-icon kind="ghost" aria-label="Align right">${Icons.alignRight}</z-toggle-button>
				  </z-toolbar-group>
				</z-toolbar>
			`
		}),
	...
	related: [
		{ tag: 'z-toolbar', route: '/elements/actionables/z-toolbar', description: 'The bar these groups live in.' },
		{ tag: 'z-separator', route: '/elements/structure/z-separator', description: 'A purely visual divider.' },
		{ tag: 'z-button-group', route: '/elements/actionables/z-button-group', description: 'Buttons joined into one seamless control.' }
	]
}
