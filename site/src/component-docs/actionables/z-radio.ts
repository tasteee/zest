...
export const zRadioDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-radio-group', route: '/elements/actionables/z-radio-group', description: 'The coordinator. Radios belong inside one.' },
		{ tag: 'z-checkbox', route: '/elements/actionables/z-checkbox', description: 'When more than one option can be true.' },
		{ tag: 'z-select', route: '/elements/actionables/z-select', description: 'When the option list grows past what is worth showing at once.' }
	]
}
