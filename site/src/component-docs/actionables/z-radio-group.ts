...
export const zRadioGroupDoc: ComponentDocT = {
	...
	related: [
		{ tag: 'z-radio', route: '/elements/actionables/z-radio', description: 'The options this group coordinates.' },
		{ tag: 'z-toggle-button-group', route: '/elements/actionables/z-toggle-button-group', description: 'The same single-selection model, drawn as buttons.' },
		{ tag: 'z-select', route: '/elements/actionables/z-select', description: 'When the list is too long to show all at once.' }
	]
}
