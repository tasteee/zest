...
export const zSelectDoc: ComponentDocT = {
	...
	playground: {
		...
		controlNames: ['placeholder', 'size', 'accent', 'is-invalid', 'is-disabled', 'inline'],
	...
	related: [
		{ tag: 'z-combobox', route: '/elements/actionables/z-combobox', description: 'The same panel, with typing to filter.' },
		{ tag: 'z-radio-group', route: '/elements/actionables/z-radio-group', description: 'When every option is worth showing at once.' },
		{ tag: 'z-menu', route: '/elements/navigation/z-menu', description: 'For actions rather than a value.' },
		{ tag: 'z-field', route: '/elements/actionables/z-field', description: 'Label, help text, and error treatment.' }
	]
}
