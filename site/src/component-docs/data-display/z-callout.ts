...
export const zCalloutDoc: ComponentDocT = {
	...
	usageGuidance: [
		'Alert reacts to what the app just did; callout annotates what you\'re reading. Use it inside prose — a callout in an application interface is almost always a `z-alert` wearing the wrong component.',
	...
	related: [
		{ tag: 'z-alert', route: '/elements/overlays/z-alert', description: 'For system state rather than prose emphasis.' },
		{ tag: 'z-collapsible', route: '/elements/interactive/z-collapsible', description: 'For hiding a whole section rather than clamping copy.' }
	]
}
