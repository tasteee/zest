...
export function HeroSection({ onInView }: HeroSectionProps) {
	...
	return (
		<section ref={sectionRef} id='hero' className='min-h-screen flex flex-col justify-center px-6 lg:px-12 pt-24 pb-20'>
			<div className='max-w-7xl mx-auto w-full'>
				...
				<p className='text-foreground text-xl md:text-2xl lg:text-3xl font-light max-w-2xl leading-relaxed mb-16'>
					Same great value, great new <span className='text-neon-pink font-black italic'>taste.</span>
				</p>

				{/* Stats Row */}
				<div className='grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-16 border-t border-border pt-12'>
					<div>
						<span className='text-neon-pink text-3xl md:text-4xl font-bold block mb-2'>4</span>
						<span className='text-muted-foreground text-sm'>Brand Colors</span>
					</div>
					<div>
						<span className='text-neon-purple text-3xl md:text-4xl font-bold block mb-2'>DM</span>
						<span className='text-muted-foreground text-sm'>Sans Typeface</span>
					</div>
					<div>
						<span className='text-neon-pink text-3xl md:text-4xl font-bold block mb-2'>∞</span>
						<span className='text-muted-foreground text-sm'>Possibilities</span>
					</div>
					<div>
						<span className='text-neon-purple text-3xl md:text-4xl font-bold block mb-2'>0</span>
				...
				<div className='mt-20 flex items-center gap-4'>
					...
					<span className='text-muted-foreground text-xs tracking-wider uppercase'>Scroll to explore</span>
				</div>
			</div>
		</section>
	)
