...
const voicePrinciples = [
  {
    title: "Direct",
    description: "Say what you mean. No corporate speak, no fluff, no dancing around the point.",
    example: "\"Join the waitlist\" not \"We'd love for you to consider joining our exclusive waitlist experience\"",
    color: "neon-green",
  },
  {
    title: "Confident",
    description: "We know our shit. Speak with authority but never arrogance.",
...
const toneSpectrum = [
  { context: "Error messages", tone: "Calm + Direct", example: "Something broke. We're on it." },
  { context: "Success states", tone: "Celebratory", example: "Fuck yes. You did it." },
  { context: "Onboarding", tone: "Warm + Guiding", example: "Let's get you set up. No bullshit, promise." },
  { context: "Marketing", tone: "Bold + Provocative", example: "Ready to stop playing it safe?" },
  { context: "Support", tone: "Empathetic + Honest", example: "That sucks. Here's what we can do." },
]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {voicePrinciples.map((principle) => (
              ...
              >
                <h4 className={`text-${principle.color} font-bold text-2xl mb-4`}>
                  {principle.title}
                </h4>
                ...
                <div className="border-t border-border pt-6">
                  <span className="text-muted-foreground text-xs tracking-wider uppercase block mb-2">Example</span>
                  <p className="text-foreground text-sm italic">{principle.example}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            {toneSpectrum.map((item, index) => (
              ...
              >
                ...
                <div className="lg:w-40 shrink-0">
                  <span className="text-foreground font-medium">{item.tone}</span>
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="border border-neon-green/30 rounded-lg p-8">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                <span className="text-neon-green mt-1">•</span>
                <span className="text-foreground">&quot;No cap, this slaps.&quot;</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-green mt-1">•</span>
                <span className="text-foreground">&quot;Built different. Hits different.&quot;</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-green mt-1">•</span>
                <span className="text-foreground">&quot;You in or you out?&quot;</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-green mt-1">•</span>
                <span className="text-foreground">&quot;Real ones know.&quot;</span>
              </li>
            </ul>
          </div>
          ...
          <div className="border border-neon-pink/30 rounded-lg p-8">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-foreground">&quot;We&apos;re excited to announce...&quot;</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-pink mt-1">•</span>
                <span className="text-foreground">&quot;Please don&apos;t hesitate to reach out.&quot;</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-pink mt-1">•</span>
                <span className="text-foreground">&quot;Best-in-class synergy...&quot;</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-pink mt-1">•</span>
                <span className="text-foreground">&quot;We appreciate your patience.&quot;</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-pink mt-1">•</span>
                <span className="text-foreground">&quot;Circle back to leverage...&quot;</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-24 text-center">
          <blockquote className="text-primary font-bold text-3xl md:text-4xl lg:text-5xl leading-tight max-w-4xl mx-auto">
            &quot;We don&apos;t whisper.
            <br />
            <span className="text-neon-green">We announce.</span>&quot;
          </blockquote>
        </div>
      </div>
    </section>
