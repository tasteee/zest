...
export function VoiceTone({ onInView }: VoiceToneProps) {
	...
	return (
		<section ref={sectionRef} id='voice' className='min-h-screen px-6 lg:px-12 py-24 border-t border-border'>
			<div className='max-w-7xl mx-auto'>
				{/* Section Header */}
				<div className='mb-20'>
					<div className='flex items-center gap-4 mb-6'>
						<span className='text-neon-purple text-xs font-semibold tracking-[0.2em] uppercase'>04</span>
						<div className='h-px flex-1 max-w-16 bg-border' />
					</div>
					<h2 className='text-primary font-bold text-4xl md:text-5xl lg:text-6xl tracking-tight mb-6'>Voice & Tone</h2>
				...
				<div className='mb-24'>
					...
					<div className='grid md:grid-cols-2 gap-6'>
						{voicePrinciples.map((principle) => (
							...
							>
								<h4 className={`text-${principle.color} font-bold text-2xl mb-4`}>{principle.title}</h4>
								<p className='text-foreground mb-6 leading-relaxed'>{principle.description}</p>
						...
						{toneSpectrum.map((item, index) => (
							...
							>
								<div className='lg:w-40 shrink-0'>
									<span className='text-neon-pink text-xs font-semibold tracking-wider uppercase'>{item.context}</span>
								</div>
								<div className='lg:w-40 shrink-0'>
				...
				<div className='grid lg:grid-cols-2 gap-8'>
					<div className='border border-neon-purple/30 rounded-lg p-8'>
						<h4 className='text-neon-purple font-bold text-xl mb-6 flex items-center gap-3'>
