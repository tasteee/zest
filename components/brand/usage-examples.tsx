...
export function UsageExamples({ onInView }: UsageExamplesProps) {
	...
	return (
		<section ref={sectionRef} id='usage' className='min-h-screen px-6 lg:px-12 py-24 border-t border-border'>
			<div className='max-w-7xl mx-auto'>
				{/* Section Header */}
				<div className='mb-20'>
					<div className='flex items-center gap-4 mb-6'>
						<span className='text-neon-purple text-xs font-semibold tracking-[0.2em] uppercase'>06</span>
						<div className='h-px flex-1 max-w-16 bg-border' />
					</div>
					<h2 className='text-primary font-bold text-4xl md:text-5xl lg:text-6xl tracking-tight mb-6'>Usage Examples</h2>
					<p className='text-foreground text-lg max-w-2xl leading-relaxed'>
						See the system in action.
						<span className='text-muted-foreground'> Real patterns, real context.</span>
					</p>
				</div>
				...
				<div className='mb-20'>
					...
					<div className='border border-border rounded-lg p-8 max-w-2xl'>
						<div className='flex items-center justify-between mb-6'>
							...
							<span className='bg-neon-purple/15 text-neon-purple text-xs font-semibold px-3 py-1.5 rounded-full'>Live</span>
						</div>

						<div className='grid grid-cols-3 gap-6 mb-6'>
							<div>
								<span className='text-muted-foreground text-xs block mb-1'>Impressions</span>
								<span className='text-primary font-bold text-2xl'>1.2M</span>
							</div>
							<div>
								<span className='text-muted-foreground text-xs block mb-1'>Engagement</span>
								<span className='text-neon-purple font-bold text-2xl'>8.4%</span>
							</div>
							<div>
								<span className='text-muted-foreground text-xs block mb-1'>Conversions</span>
								<span className='text-neon-pink font-bold text-2xl'>2.1K</span>
							</div>
						</div>
				...
				<div className='mb-20'>
					...
					<div className='space-y-4 max-w-2xl'>
						...
						{/* Warning */}
						<div className='border border-neon-pink/30 bg-neon-pink/5 rounded-lg p-4 flex items-start gap-4'>
							<div className='text-neon-pink shrink-0 mt-0.5'>
								<svg className='w-5 h-5' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth={2}>
									<path
										strokeLinecap='round'
							...
							<div>
								<h4 className='text-primary font-semibold text-sm mb-1'>Budget running low</h4>
								<p className='text-foreground text-sm'>You&apos;ve used 85% of your monthly budget. Top up or chill—your call.</p>
							</div>
						</div>
					...
					<div className='border border-border rounded-lg overflow-hidden max-w-4xl'>
						...
						<div className='border-b border-border p-4 flex items-center justify-between'>
							...
							<div className='flex items-center gap-6'>
								<span className='text-primary text-sm font-medium'>Dashboard</span>
							...
							<div className='flex items-center gap-3'>
								<span className='bg-neon-pink/15 text-neon-pink text-xs font-semibold px-2 py-1 rounded'>Pro</span>
				...
				<div>
					...
					<div className='border border-border rounded-lg overflow-hidden'>
						...
						<div className='grid grid-cols-12 gap-4 px-6 py-4 border-b border-border'>
							<span className='col-span-4 text-muted-foreground text-xs font-semibold tracking-wider uppercase'>Campaign</span>
							<span className='col-span-2 text-muted-foreground text-xs font-semibold tracking-wider uppercase'>Status</span>
							<span className='col-span-2 text-muted-foreground text-xs font-semibold tracking-wider uppercase'>Reach</span>
							<span className='col-span-2 text-muted-foreground text-xs font-semibold tracking-wider uppercase'>Engagement</span>
							<span className='col-span-2 text-muted-foreground text-xs font-semibold tracking-wider uppercase'>Actions</span>
						</div>
						...
						{[
							...
							>
								...
								<div className='col-span-2'>
									<span className={`text-${row.statusColor} text-xs font-semibold`}>• {row.status}</span>
								</div>
								<div className='col-span-2'>
								...
								<div className='col-span-2'>
									<button className='text-muted-foreground text-sm hover:text-primary transition-colors'>Edit →</button>
								</div>
							</div>
						))}
					</div>
				...
				<div className='mt-32 text-center border border-border rounded-lg p-12 lg:p-20'>
					<span className='text-neon-purple text-xs font-semibold tracking-[0.2em] uppercase block mb-6'>Ready?</span>
