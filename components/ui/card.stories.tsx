        ...
        <div>
          ...
          <div style={cardGridStyle}>
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Card content goes here. This is a simple example.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Some content for this card example.
                </p>
              </CardContent>
          ...
          <div style={cardGridStyle}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Optimized for speed with instant responses.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                <div className="flex size-10 items-center justify-center rounded-lg bg-neon-purple/10">
                  <Phosphor.Shield
                    className="size-5 text-neon-purple"
                    weight="fill"
                  />
                </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex size-10 items-center justify-center rounded-lg bg-neon-pink/10">
                  <Phosphor.Sparkle
                    className="size-5 text-neon-pink"
                    weight="fill"
                  />
                </div>
