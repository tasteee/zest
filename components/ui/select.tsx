...
function SelectItem(props: React.ComponentProps<typeof SelectPrimitive.Item>) {
	...
	return (
		<SelectPrimitive.Item
			...
			className={cn(
				"focus:bg-black/5 focus:text-foreground dark:focus:bg-neutral/10 [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
				props.className
			)}
		>
