...
type SidebarMenuButtonVariantT = 'default' | 'outline'
type SidebarMenuButtonSizeT = 'default' | 'sm' | 'lg'

type SidebarMenuButtonVariantOptionsT = {
	variant?: SidebarMenuButtonVariantT | null
	size?: SidebarMenuButtonSizeT | null
}

const sidebarMenuButtonVariants = (options?: SidebarMenuButtonVariantOptionsT): string => {
...
} & SidebarMenuButtonVariantOptionsT) {
	const Comp = asChild ? Slot : 'button'
