...
const inputVariants = (options?: InputVariantOptionsT): string => {
	...
	return cn(
		...
		focusColor === 'neutral' &&
			'focus-visible:border-foreground/50 focus-visible:ring-foreground/20 focus-visible:ring-[3px]',
		focusColor === 'purple' && 'focus-visible:border-neon-purple focus-visible:ring-neon-purple/30 focus-visible:ring-[3px]',
		focusColor === 'pink' && 'focus-visible:border-neon-pink focus-visible:ring-neon-pink/30 focus-visible:ring-[3px]'
	)
}

type InputPropsT = React.ComponentProps<'input'> & InputVariantOptionsT

function Input({ className, type, focusColor, ...props }: InputPropsT) {
