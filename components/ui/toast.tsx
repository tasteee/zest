...
type ToastVariantOptionsT = {
	variant?: ToastVariantT | null
}

const toastVariants = (options?: ToastVariantOptionsT): string => {
...
const Toast = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof ToastPrimitives.Root> & ToastVariantOptionsT
