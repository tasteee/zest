...
[wired-row](../structure/wired-row.md) and [wired-column](../structure/wired-column.md) are thin
...
[wired-grid](../structure/wired-grid.md), which owns that job properly. The one modifier
