      ...
      All three can be open at the same time!
				...
				>
					<Accordion type='multiple' className='w-full max-w-lg'>
						<AccordionItem value='item-1'>
							<AccordionTrigger>First Section</AccordionTrigger>
							<AccordionContent>This section can stay open while others are opened.</AccordionContent>
						</AccordionItem>
						<AccordionItem value='item-2'>
							<AccordionTrigger>Second Section</AccordionTrigger>
							<AccordionContent>This section can also remain open simultaneously.</AccordionContent>
						</AccordionItem>
						<AccordionItem value='item-3'>
							<AccordionTrigger>Third Section</AccordionTrigger>
							<AccordionContent>All three can be open at the same time!</AccordionContent>
						</AccordionItem>
					</Accordion>
				</ComponentPreview>
      ...
      This item is open when the page loads.
				...
				>
					<Accordion type='single' collapsible defaultValue='item-2' className='w-full max-w-lg'>
						...
						<AccordionItem value='item-2'>
							<AccordionTrigger>Open by default</AccordionTrigger>
							<AccordionContent>This item is open when the page loads.</AccordionContent>
						</AccordionItem>
					</Accordion>
				</ComponentPreview>
