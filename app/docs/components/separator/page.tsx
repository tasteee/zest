		...
		<div className='space-y-16'>
			...
			<div className='space-y-4'>
				<div className='flex items-center gap-3'>
					<h1 className='text-4xl font-bold tracking-tight text-foreground'>ZSeparator</h1>
					<z.badge isGhost isWhite>
						Component
					</z.badge>
				</div>
				<p className='text-xl text-muted-foreground max-w-2xl leading-relaxed'>
					Visually or semantically separates content. A simple line that can be horizontal or vertical.
				</p>
			</div>
      ...
      <div className="flex h-5 items-center space-x-4 text-sm">
        ...
        <div>Source</div>
			...
			<section className='space-y-6'>
				...
				<CodeBlock code={`import { ZSeparator } from '@tasteee/zest'`} language='tsx' />
				<CodeBlock code={`<ZSeparator />`} language='tsx' />
			</section>
				...
				<Card>
					<CardContent className='p-6 space-y-4'>
						<div className='space-y-2'>
							...
							<p className='text-sm text-muted-foreground'>
								By default, the separator is decorative and has no semantic meaning. Set{' '}
								<code className='text-xs bg-muted px-1 py-0.5 rounded'>decorative=false</code> when the separator has semantic
						...
						<div className='space-y-2'>
							...
							<p className='text-sm text-muted-foreground'>
								When <code className='text-xs bg-muted px-1 py-0.5 rounded'>decorative</code> is false, the separator uses{' '}
