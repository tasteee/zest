					...
					{sections.map((section) => (
						...
						>
							<div className='flex items-start justify-between mb-4'>
								<h3 className={`text-xl font-semibold text-${section.color}`}>{section.title}</h3>
			...
			<DocsSection>
				...
				<div className='grid gap-6 md:grid-cols-2'>
					...
					<div className='rounded-lg border border-border p-6'>
						...
						<p className='text-sm text-foreground'>Every component is built with accessibility in mind. No exceptions.</p>
					</div>
					<div className='rounded-lg border border-border p-6'>
						<div className='flex items-center gap-3 mb-3'>
							<div className='w-2 h-2 rounded-full bg-neon-purple' />
						...
						<p className='text-sm text-foreground'>Small, focused components that compose into complex interfaces.</p>
					</div>
					<div className='rounded-lg border border-border p-6'>
						<div className='flex items-center gap-3 mb-3'>
							<div className='w-2 h-2 rounded-full bg-neon-pink' />
