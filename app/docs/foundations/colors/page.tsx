  ...
  return (
    <div>
      ...
      <DocsSection>
        ...
        <DocsText>
          The signature colors of tasteink. Bold, vibrant, and unapologetic.
          Use these for interactive elements, badges, and key highlights.
        </DocsText>
        <DocsGrid columns={2}>
      ...
      <DocsSection>
        ...
        <DocsText>
          The foundation of our interface. These colors define the visual hierarchy
          and ensure consistent contrast throughout the design system.
        </DocsText>
      ...
      <DocsSection>
        ...
        <DocsText>
          Use the semantic color classes directly in your components:
        </DocsText>
        <CodeBlock
...
<span className="text-neon-pink">Accent text</span>`}
        ...
        <DocsText>
          Access colors via CSS variables for custom styling:
        </DocsText>
        <CodeBlock
          code={`.custom-element {
...
.gradient-accent {
  background: linear-gradient(
    ...
    var(--neon-purple)
      ...
      <DocsNote>
        All colors are defined using OKLCH for perceptual uniformity.
        This ensures consistent brightness across the color palette.
      </DocsNote>
    </div>
  );
}
