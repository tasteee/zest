...
// of these tokens is turned into a custom element/class. Ported from the
// reference implementation; styling for the classes is a later polish item.
...
export const customMarkers: Record<string, MarkerDefinitionT> = {
	'!BIG': { element: 'p', classes: 'zText isLarge' },
	'!SMALL': { element: 'p', classes: 'zText isSmall' },
	'!CAPS': { element: 'p', classes: 'zText isSmall isSmallCaps' },
	'!NOTE': { element: 'p', classes: 'zNoteCallout callout callout-note' },
	...
	'!CENTER': { element: 'p', classes: 'zText isCenteredBlock' },
	'!CAPTION': { element: 'p', classes: 'zTextCaption' },
	'!H1': { element: 'h1', classes: 'zTextH1' },
	'!H2': { element: 'h2', classes: 'zTextH2' },
	'!H3': { element: 'h3', classes: 'zTextH3' },
	'!H4': { element: 'h4', classes: 'zTextH4' },
	'!H5': { element: 'h5', classes: 'zTextH5' },
	'!H6': { element: 'h6', classes: 'zTextH6' },
	'!BASH': { element: 'pre', classes: 'zCodeBash', attributes: { 'data-language': 'bash' } },
	'!QUOTE': { element: 'blockquote', classes: 'zQuote' },
